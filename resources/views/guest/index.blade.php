...
<div class="max-w-6xl mx-auto px-4 py-10">
    ...
    {{-- Hero Section --}}
    <section 
        class="mb-12 bg-gradient-to-r from-blue-500 to-violet-600 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden animate-fade-in-up"
    >
        <!-- Background overlay -->
    ...
    @php
        ...
        // Ambil data foto dengan total like (user + guest)
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach((entry, index) => {
            if (entry.isIntersecting) {
                ...
                }, index * 150); // delay bertahap antar card
            }
        });
    }, { threshold: 0.2 });
